                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="assets/img/avatars/Capture.JPG" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Anna-Chan</span>
                            <small class="text-muted">Girlfriend</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="card-title d-flex align-items-start justify-content-between">
                          ...
                          <img src="data:image/png;base64,"/>
                          </div>
                         
                        </div>
                        <span class="fw-semibold d-block mb-1">Jumlah siswa/i</span>
                  ...
                  <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <span>Jumlah Seragam</span>
                        <h3 class="card-title text-nowrap mb-1">390</h3>
                        </div>
                    </div>
                  </div>
                </div>
