...
include "../koneksi.php"
  ...
  <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Gelombang dan Harga</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <!-- Form untuk menambahkan admin atau petugas bisa Anda tambahkan di sini -->
          <form action="proses/pros_tambah_gel.php" method="POST">
            <div class="form-group">
              <label for="nama">Gelombang</label>
              <input type="text" class="form-control" name="gelombang" id="nama" placeholder="Masukkan Gelombang">
            </div>
            <div class="form-group">
              <label for="username">Harga</label>
              <input type="text" class="form-control" id="username" name="harga" placeholder="Masukkan Nominal">
            </div>
