...
include "../koneksi.php"
  ...
  <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalScrollableTitle">Tambah Admin/Petugas</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          ...
          <form action="proses/proses_tambah.php" method="POST">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="sebagai" id="role">
              <option value="pilih" name="sebagai">Pilih</option>
                <option value="admin" name="sebagai">Admin</option>
                <option value="petugas " name="sebagai">Petugas</option>
              </select>
            </div>
